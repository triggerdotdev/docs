...
![org sidebar](https://imagedelivery.net/3TbraffuDZ4aEf8KWOmI_w/4b559572-1e9a-4eb1-7296-1520f4ae8300/public)
...
<Info>
  We're going to be releasing an update soon that changes this behaviour, where
  only the `live` environment will be triggered on a schedule, and test runs
  will be required to trigger `development` runs.
</Info>
...
![changing envs](https://imagedelivery.net/3TbraffuDZ4aEf8KWOmI_w/fbd062c7-3dfe-427f-e69f-204c84828500/public)
