...
If you don't already have a long-running Node.js server, you can visit our [Templates](https://app.trigger.dev/templates) page to get started with a pre-configured project and we'll walk you through the steps to get your first workflow running.
