...
Notice how the `body` is an object, and will be automatically stringified as JSON. This is because the `fetch` function currently only supports JSON request and response bodies. See [Params](#params) for more information.
